...
// crate::serve::tab::{next_after, count_decisions} (generic). Callers in
// this crate import directly from crate::serve::tab.
...
mod tests {
    ...
    // next_after generic tests live in crate::serve::tab; nothing to retest here.
}
