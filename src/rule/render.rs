...
//! grid. The `--json` branches delegate their payloads to `crate::rule::json`.
...
use crate::rule::helpers::{commas, money, sanitize};
use crate::rule::table::{render_table, Align, Cell};
use crate::rule::{json, AppError};
